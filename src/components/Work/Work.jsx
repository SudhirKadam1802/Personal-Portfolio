...
const Work = () => {
  ...
  >
   <div
  className="relative bg-gray-900 rounded-2xl shadow-2xl w-[95%] max-w-4xl max-h-[90vh] overflow-y-auto animate-[fadeIn_0.3s_ease]"
  onClick={(e) => e.stopPropagation()}
>
      <button
        onClick={handleCloseModal}
        className="absolute top-4 right-4 w-10 h-10 flex items-center justify-center rounded-full bg-black/50 text-white text-2xl hover:bg-purple-600 transition z-50"
      >
        &times;
      </button>
